...
/**
 * \file    lib/websiteaccount.lib.php
 * \ingroup monmodule
...
function websiteaccountPrepareHead($object)
{
	...
	$head[$h][0] = dol_buildpath("/monmodule/websiteaccount_card.php", 1).'?id='.$object->id;
	...
	//	'entity:-tabname:Title:@monmodule:/monmodule/mypage.php?id=__ID__'
	//); // to remove a tab
	complete_head_from_modules($conf, $langs, $object, $head, $h, 'websiteaccount@monmodule');
